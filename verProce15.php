...
if (isset($_POST["txtRegistro15"])) {

    $regre = $_POST["txtRegistro15"];

    if ($regre == "VER SUCESOR") {

        echo' <script> ';
        echo' $(document).ready(function (event) {';
        echo' $("#btnver16").click(function () {';
        echo' $("#txtRegistro16").val("VER SUCESOR");';
        echo' $.ajax({';
        echo' type: "POST",';
        echo' url: "verProce16.php",';
        echo' data: $("#formu16").serialize(),';
        echo' success: function (data) {';
        echo' $("#muestra16").html(data);';
        echo' }';
        echo' });';
        echo' })';
        echo' });';
       ...
       echo' <div class=" container col-6 ">';
        ...
        echo' <div class=" container col-6 "  >';
        echo' <form id="formu16">';
        echo' <table class="table tab-content row">';
        echo' <td>';
        

        if ($cont > 0) {
            echo' <select name="list16" class="list-group-item-action" style="height: 30px; width: 300px" > ';
        ...
        echo' </td>';
        echo' <td>';
        echo' <input type = "button" class = "btn btn-success  " value = "VER SUCESOR" id = "btnver16" style = "width: 130px; height: 30px;  " />';
        echo' </td>';
        echo' </table>';
        echo' <input type = "hidden" name = "txtRegistro16" id = "txtRegistro16">';
        echo' </form>';
        echo' </div>';
        echo' <div id = "muestra16" class = "container table-hover" >';
        echo' </div> ';
    }
    return;
}