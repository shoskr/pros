...
if (isset($_POST["txtRegistro16"])) {

    $regre = $_POST["txtRegistro16"];

    if ($regre == "VER SUCESOR") {

        echo' <script> ';
        echo' $(document).ready(function (event) {';
        echo' $("#btnver17").click(function () {';
        echo' $("#txtRegistro17").val("VER SUCESOR");';
        echo' $.ajax({';
        echo' type: "POST",';
        echo' url: "verProce17.php",';
        echo' data: $("#formu17").serialize(),';
        echo' success: function (data) {';
        echo' $("#muestra17").html(data);';
        echo' }';
        echo' });';
        echo' })';
        echo' });';
