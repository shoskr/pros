...
if (isset($_POST["txtRegistro17"])) {

    $regre = $_POST["txtRegistro17"];

    if ($regre == "VER SUCESOR") {

        echo' <script> ';
        echo' $(document).ready(function (event) {';
        echo' $("#btnver18").click(function () {';
        echo' $("#txtRegistro18").val("VER SUCESOR");';
        echo' $.ajax({';
        echo' type: "POST",';
        echo' url: "verProce18.php",';
        echo' data: $("#formu18").serialize(),';
        echo' success: function (data) {';
        echo' $("#muestra18").html(data);';
        echo' }';
        echo' });';
        echo' })';
        echo' });';
       ...
       echo' <div class=" container col-6 ">';
        ...
        echo' <div class=" container col-6 "  >';
        echo' <form id="formu18">';
        echo' <table class="table tab-content row">';
        echo' <td>';
       

        if ($cont > 0) {
            echo' <select name="list18" class="list-group-item-action" style="height: 30px; width: 300px" > ';
        ...
        echo' </td>';
        echo' <td>';
        echo' <input type = "button" class = "btn btn-success  " value = "VER SUCESOR" id = "btnver18" style = "width: 130px; height: 30px;  " />';
        echo' </td>';
        echo' </table>';
        echo' <input type = "hidden" name = "txtRegistro18" id = "txtRegistro18">';
        echo' </form>';
        echo' </div>';
        echo' <div id = "muestra18" class = "container table-hover" >';
        echo' </div> ';
    }
    return;
}