...
if (isset($_POST["txtRegistro4"])) {

    $regre = $_POST["txtRegistro4"];

    if ($regre == "VER SUCESOR") {

        echo' <script> ';
        echo' $(document).ready(function (event) {';
        echo' $("#btnver5").click(function () {';
        echo' $("#txtRegistro5").val("VER SUCESOR");';
        echo' $.ajax({';
        echo' type: "POST",';
        echo' url: "verProce5.php",';
        echo' data: $("#formu5").serialize(),';
        echo' success: function (data) {';
        echo' $("#muestra5").html(data);';
        echo' }';
        echo' });';
        echo' })';
        echo' });';
       ...
       echo' <div class=" container col-6 ">';
        ...
        if ($cont > 0) {
            echo' <select name="list5" class="list-group-item-action" style="height: 30px ; width: 300px" > ';
        ...
        echo' </td>';
        echo' <td>';
        echo' <input type = "button" class = "btn btn-success  " value = "VER SUCESOR" id = "btnver5" style = "width: 130px; height: 30px;  " />';
        echo' </td>';
        echo' </table>';
        echo' <input type = "hidden" name = "txtRegistro5" id = "txtRegistro5">';
        echo' </form>';
        echo' </div>';
        echo' <div id = "muestra5" class = "container table-hover" >';
        echo' </div> ';
    }
    return;
}